...
public class HumanProxy 
{
	...
	public HumanProxy(GeneralAgent generalAgent, Collection<BiFunction<Observation, Observation, Double>> evaluators,
	...
	public HumanProxy(Collection<GeneralAgent> agents, Collection<BiFunction<Observation, Observation, Double>> evaluators,
			BiFunction<Observation, Action, Observation> mapping)
	{
...
//		RotationAgent r_agent = multiAgent ? (RotationAgent)this.agent : null;
	...
	public static void main(String[] args)
	{
		...
		g.add_agent(new MoralTamerAgent());
		HumanProxy h = new HumanProxy(g.getRotation(), evals, factory.transitionFunc());
