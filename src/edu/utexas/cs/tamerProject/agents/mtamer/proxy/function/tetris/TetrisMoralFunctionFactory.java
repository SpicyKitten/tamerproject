...
public class TetrisMoralFunctionFactory extends EnvironmentFunctionFactory
{
	public TetrisMoralFunctionFactory()
	{
		this.addConstructor("transition", TetrisTransitionFactory::new);
		this.addConstructor("evaluation", varArgs(TetrisMoralityFactory::new));
